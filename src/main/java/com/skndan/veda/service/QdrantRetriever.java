...
public class QdrantRetriever implements Supplier<RetrievalAugmentor> {
    ...
    private static final ThreadLocal<List<SourceInfo>> RETRIEVED_SOURCES = 
                ...
                for (int i = 0; i < contents.size(); i++) {
                    ...
                    if (textSegment != null) {
                        ...
                        if (metadata != null) {
                            ...
                            score = metadata.getDouble("score");
                        }
                        
                        // Store source info
                        sourcesStorage.get().add(new SourceInfo(fileName, text, score, i + 1));
                    }
                }
